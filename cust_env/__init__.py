...
register(
    id="quantum_nonlinear_obser_Pn-v0",
    entry_point="gym.envs.classic_control:quantum_nonlinear_obser_Pn",
    max_episode_steps=200000,
)

register(
    id="quantum_nonlinear_obser_EN-v0",
    entry_point="gym.envs.classic_control:quantum_nonlinear_obser_EN",
    max_episode_steps=200000,
)

register(
    id="quantumNonlinearEnvSMEExpPn-v0",
    entry_point="gym.envs.classic_control:quantumNonlinearEnvSMEExpPn",
    max_episode_steps=200000,
)

register(
    id="quantumNonlinearEnvSMEExpEN-v0",
    entry_point="gym.envs.classic_control:quantumNonlinearEnvSMEExpEN",
    max_episode_steps=200000,
)


register(
    id="quantumEnvMeasureFilter_randomInitial-v0",
    entry_point="gym.envs.classic_control:quantumEnvMeasureFilter_randomInitial",
    max_episode_steps=200000,
)

register(
    id="quantumEnvMeasureFilter_update-v0",
    entry_point="gym.envs.classic_control:quantumEnvMeasureFilter_update",
    max_episode_steps=200000,
)

register(
    id="quantumEnvMeasureFilter-v0",
    entry_point="gym.envs.classic_control:quantumEnvMeasureFilter",
    max_episode_steps=200000,
)

register(
    id="quantumEnvExp_randomInitial-v0",
    entry_point="gym.envs.classic_control:quantumEnvExp_randomInitial",
    max_episode_steps=200000,
)

register(
    id="quantumEnvExp_update-v0",
    entry_point="gym.envs.classic_control:quantumEnvExp_update",
    max_episode_steps=200000,
)

register(
    id="quantumEnvExp-v0",
    entry_point="gym.envs.classic_control:quantumEnvExp",
    max_episode_steps=200000,
)

register(
    id="doubleWellEnv-v0",
    entry_point="gym.envs.classic_control:doubleWellEnv",
    max_episode_steps=200000,
)

...
class quantumEnvMeasureFilter_randomInitial(gym.Env):
    """Custom Environment that follows gym interface"""

    def __init__(self,measure_rate,n_steps,n_envs,n_episode,mean_interval,ntraj,filter_interval,\
                 gaussian_var,output_interval,rundir,kappa):
    ...
    def reset(self):
        ...
        self.mix_p = np.random.uniform(0,1)
        ...
        observation = [1-self.mix_p] #numPhoton

        ...
        if self.numStep == self.n_steps:
           ...
           if self.numEpisode < self.n_episode:
               ...
               if self.numEpisode in range(self.output_interval,self.n_episode,self.output_interval):
                     np.save('./dataImp/controlG_'+str(self.numEpisode)+'.npy',self.controlG)
                     np.save('./dataImp/exp_current_'+str(self.numEpisode)+'.npy',self.exp_current)
                     np.save('./dataImp/EN0_step_'+str(self.numEpisode)+'.npy',self.EN0_step)
                     np.save('./dataImp/EN1_step_'+str(self.numEpisode)+'.npy',self.EN1_step)
                     ...
                     plt.yticks(fontsize=16)
                     plt.xticks(fontsize=16)
                     plt.savefig('./picture/exp_current_'+str(self.numEpisode)+'.png',bbox_inches='tight')
                     plt.close()

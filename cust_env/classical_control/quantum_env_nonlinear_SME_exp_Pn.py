...
class quantumNonlinearEnvSMEExpPn(gym.Env):
    """Custom Environment that follows gym interface"""
    # metadata = {"render.modes": ["human", "rgb_array"], "video.frames_per_second": 50}

    def __init__(self,rundir,N,g_0,kappa,measure_rate,n_steps,n_episode,output_interval,n_envs,target_idx):
        ...
        self.Pn_target = np.load('./Pn_target/measureRate_'+str(measure_rate)+'/Pn_step_'+str(target_idx)+'.npy')
    ...
    def step(self, action):
        ...
        observation = [Pn]#Pn
        reward = -abs(Pn-self.Pn_target[self.numStep-2])
        ...
        return observation, reward, self.done, {0:E_N_1,1:E_N_0,2:Mn,3:Fidelity}

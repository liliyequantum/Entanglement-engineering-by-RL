...
alpha_L = np.load('./dataImp/alpha_L_800.npy')
Delta = np.load('./dataImp/Delta_800.npy')
...
E_N_0 = np.load('./dataImp/EN0_step_800.npy')
E_N_1 = np.load('./dataImp/EN1_step_800.npy')
...
Pn = np.load('./dataImp/Pn_step_800.npy')
Mn = np.load('./dataImp/Mn_step_800.npy')
...
reward = np.load('./dataImp/reward_env_800.npy')
...
plt.yticks(fontsize=fontsize_define)
plt.xticks([0,200,400,600,800],fontsize=fontsize_define)

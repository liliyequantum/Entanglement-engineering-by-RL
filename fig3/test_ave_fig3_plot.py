...
def plot(dirname,num_time,num_repeat):
    ...
    ave_E_N_0_time = _ave(num_time, 100, E_N_0[:,num_repeat-1])
    ave_E_N_1_time = _ave(num_time, 100, E_N_1[:,num_repeat-1])
    ...
    plt.xlabel(r'$t(\omega_{m}^{-1})$',fontsize=16)
    plt.ylabel(r'$E_N(t)$',fontsize=16)
    plt.xticks(fontsize=15)
    plt.yticks([0,0.3,0.5,0.7],fontsize=15)
    plt.show()
    ...
    # plt.plot(0.01*np.arange(0,num_time,1),0.5*np.ones(num_time,),color='gray',linewidth=2,alpha=0.5)
    plt.xlabel(r'$t(\omega_{m}^{-1})$',fontsize=16)
    plt.ylabel(r'$\mathcal{I}(t)$',fontsize=16)
    plt.yticks(fontsize=15)
    plt.xticks(fontsize=15)
    plt.show()
...
if __name__ == '__main__':
    ...
    plt.ylabel(r'$\widetilde{E}_N$',fontsize=16)
    plt.yticks([0,0.3,0.5],fontsize=15)
    ...
    plt.xlabel('Episode',fontsize=16)
    plt.ylabel(r'$\widetilde{R}$',fontsize=16)
    plt.yticks([-0.8,-0.6],fontsize=15)
    plt.xticks([0,1000,2000,3000],fontsize=15)
    plt.show()
    ...
    n_steps = 4000#np.load('./train_par/n_steps.npy')
    num_time = n_steps - 2

...
if __name__ == '__main__':
    ...
    n_episode = 4500
    n_steps = 500 # times
    n_update = 15 # update neural network
    ra = 1 # reward par
    #rb = 40  # reward par
    output_interval = 100 # plot reward...
    #repeat_index = 1
    ...
    ####### dir  #######
    rundir = './measure_rate_'+str(measure_rate)+'_rb_'+str(rb)+'_repeat_index_'+str(repeat_index)
    update_dir(rundir)
    ...
    env_kwargs = {'rundir':rundir,'N':N,'g_0':g_0,'kappa':kappa,'measure_rate':measure_rate,\
                  ...
                  'ra':ra,'rb':rb}
    env_id = "quantumNonlinearEnvSMEExpEN-v0"

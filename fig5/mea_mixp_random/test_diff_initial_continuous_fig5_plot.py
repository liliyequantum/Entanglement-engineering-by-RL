...
if __name__ == '__main__':
    ...
    #                     output_interval,dirname,kappa,Mix_p[i])
    ...
    fig = plt.figure()
    plt.plot(Mix_p, percent_ave_EN,'-',color='maroon',alpha=0.5)
    plt.fill_between(Mix_p, percent_ave_EN-std_EN, percent_ave_EN+std_EN,color='lightcoral',alpha=0.2)
